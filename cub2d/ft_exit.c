...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/17 15:49:00 by nabboudi          #+#    #+#             */
/*   Updated: 2021/03/19 16:58:03 by nabboudi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			exit_game(t_cub *cub, int e)
{
	...
	free(g_east.ptr);
	free(g_west.ptr);
	free(game_data.no_path);
	free(game_data.so_path);
	free(game_data.we_path);
	free(game_data.ea_path);
	free(game_data.s_path);
	free(game_data.no_txt);
	free(game_data.so_txt);
	free(game_data.we_txt);
	free(game_data.ea_txt);
	free(game_data.s_txt);
	exit(0);
	return (0);
}
